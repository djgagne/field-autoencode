...
def random_field_generator(x, y, length_scales, spatial_pattern="full"):
    ...
    * blended: Fields with different covariances are blended with a logistic function.
    ...
    Args:
        x: all x-coordinates for every point as a 2D array
        y:  all y-coordinates for every point as a 2D array
        length_scales: List of the length scales of covariances in same unit as x and y
